...
const {createSchema,updateSchema}=require("../validations/users.validations")

const router = express.Router();

router.post("/signup", validateData(createSchema,"body"),UsersController.signup);
...
//update me
router.patch('/update', validateData(updateSchema,"body"),checkAuth, UsersController.updateUser)
